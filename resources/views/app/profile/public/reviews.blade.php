...
@section('profile-details')
    ...
    <div class="app-section-x navbar navbar-light app-navbar app-subnavbar">
        <ul class="nav navbar-nav">
            ...
            <li id="nav_reviews" class="nav-item active">
    ...
    <section class="app-section app-profile-details">
        <div id="reviews_rows" class="row">
            @include('app._partials.reviews_row', ['reviews' => $reviews])
        </div>

        <div id="reviews_more_block" class="app-adventures-load-section {{ $showMore ? '' : 'hidden-xs-up' }}">
            <button id="reviews_button_more" class="btn btn-block app-btn-apply app-border-radius-4">
